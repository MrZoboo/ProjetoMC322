...
public class MpMapUi extends GameUi {

    public MpMapUi() {
        initComponents();
        q = new Queue(p1NextShapes);
    ...
    public void startGame(){
        mp.initBackground();
        mp2.initBackground();
        gt1 = new MPGameThread(mp, mp2, this);
        gt2 = new MPGameThread(mp2, mp, this);
    ...
    protected void menuButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuButtonActionPerformed
        gt1.interrupt();
        gt2.interrupt();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MpMapUi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
